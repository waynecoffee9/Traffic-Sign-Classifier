...
[[0.3        0.21176471 0.2647059  ... 0.47058824 0.46470588 0.42941177]

 [0.2764706  0.2        0.22352941 ... 0.3764706  0.44117647 0.46470588]
 
 [0.2647059  0.1882353  0.22352941 ... 0.35882354 0.4        0.41764706]
 
 ...
 
 [0.2529412  0.22352941 0.2        ... 0.27058825 0.24705882 0.21764706]
 
 [0.25882354 0.21176471 0.18235295 ... 0.21176471 0.19411765 0.20588236]
 
 [0.24117647 0.21176471 0.22352941 ... 0.30588236 0.28235295 0.29411766]]
...
* Random sharpen / smoothing images
* Random stretch / squeeze images
* Random rotate images
* Random darken partial images
...
For learning rate, I setup maximum rate as 0.001.  As training set accuracy is closer to 100%, learning rate will be adjusted automatically after each epoch.

```javascript
    dyn_alpha = min((1 - train_accuracy)*0.01, 0.001)
```
